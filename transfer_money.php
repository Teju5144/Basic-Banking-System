...
if (isset($_POST["submit"])) {
    ...
    if ($sender_balance < $amount) {
        ...
        $sql = "INSERT INTO transfers (sender_name, sender_id, reciver_name, receiver_id, amount) VALUES ('$sender_name', '$sender_id', '$receiver_name', '$receiver_id','$amount')";
        if (!$connection->query($sql)) {
...
<body style="margin: 50px">
    <div class="container">
        ...
        <form method="POST">
            ...
            <div class="form-group">
                <label for="sender-balance">Sender Balance:</label>
                <input type="text" class="form-control" id="sender-balance" name="sender_balance"
                    value="<?php echo $sender["balance"]; ?>" readonly>
            </div>
            <div class="form-group">
                <label for="receiver-id">Receiver:</label>
                <select class="form-control" id="receiver-id" name="receiver_id">
